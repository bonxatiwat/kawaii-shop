...
func (f *productsModule) Repository() productsRepositories.IProductsRepository {
	return f.repository
}

func (f *productsModule) Usecase() productsUsecases.IProductsUsecase {
	return f.usecase
}

func (f *productsModule) Handler() productsHandlers.IProductsHandler {
	return f.handler
}
